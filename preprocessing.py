...
if __name__ == '__main__':
    ...
    for dataset_idx, dataset in enumerate(data):
        concatenated_data, y_cat, all_cat = dataset
        print(f"Dataset {dataset_idx + 1} - Number of Samples:", len(concatenated_data))
        print(f"Dataset {dataset_idx + 1} - Number of Labels:", len(y_cat))
        print("===")
